                            ...
                            <div class="row-sm-3">
                               <center> <div class="thumbnail">
                                ...
                                <div class="caption">
                                  ...
                                  <h6><a class="btn btn-success btn-round" title="Click for more details!" style="margin-bottom: 10px;" href="pages/product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="now-ui-icons gestures_tap-01"></i>View</a></h6>
                                </div>
