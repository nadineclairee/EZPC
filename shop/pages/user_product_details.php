...
<div class="main">
    ...
    <div class="section" id="carousel">
        <div class="container">
            ...
            <a class="btn btn-primary btn-round" href="user_index.php"><i class="now-ui-icons arrows-1_minimal-left"></i> &nbsp Back to products</a>
            <hr color="orange">
            <div class="col-md-12">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            ...
                            <?php endif; ?>
                            <div class="carousel-caption d-none d-md-block" style="color: red; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">
              ...
              <div class="modal-dialog">
                ...
                <div class="form group">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel" style="color: black">Enter Quantity:</h4>
                  </div>
